...
use super::{Ula128, InnerUla, Ula128VidFrame};
...
impl<B, D, X> AudioFrame<B> for Ula128<D, X>
    where B: Blep,
...
impl<B, D, X> EarMicOutAudioFrame<B> for Ula128<D, X>
    where B: Blep
{
    #[inline(always)]
...
impl<B, D, X> EarInAudioFrame<B> for Ula128<D, X>
    where B: Blep
{
    #[inline(always)]
...
impl<'a, D: 'a, X: 'a> MicOut<'a> for Ula128<D, X> {
